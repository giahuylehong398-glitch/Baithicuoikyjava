...
|-----|-----------|--------------|---------------------|----------------------|
| 1 |Lê Hồng Gia Huy  | 3120225065 | Code Controller, Code Model, Xử lý Thuật toán, Main | https://github.com/giahuylehong398-glitch |
| 2 | Trần Văn Tài | 3120225133 | Xử lý File I/O, Main, test, Báo cáo |https://github.com/tvt2007cute-debug  |
| 3 | Nguyễn Công Danh (nhóm trưởng)  | 3120225023 | Vẽ Giao diện (View), KeyListener, Đồ họa |https://github.com/congdanhhh2006767-tech  |
